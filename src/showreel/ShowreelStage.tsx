...
import { ClosingStage } from '@/components/common/footer/closing-stage';
...
export function ShowreelStage({ className }: { className?: string }) {
  ...
  return (
    <section ref={rootRef} id="showreel" className={`showreel ${className ?? ''}`} aria-label="Showreel">
