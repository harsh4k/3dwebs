...
import { AuralisShell } from "@/showreel/AuralisShell";
...
export const HomeView = () => {
  return (
    <main id="top" className="relative bg-scene-backdrop">
      <h1 className="sr-only">Coffee Digital — the digital branding people</h1>
      ...
      {/* Scroll length of the Auralis sequence, then a hold so the tree stays on screen
          before the showreel. Hold is not part of Auralis progress (that is already 1). */}
